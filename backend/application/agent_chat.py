...
_agent_chat_application: Optional[AgentChatApplication] = None


def get_agent_chat_application() -> AgentChatApplication:
    global _agent_chat_application
    return get_runtime_dependency(
        container_getter='get_agent_chat_application',
        fallback_name='agent_chat_application',
        fallback_factory=AgentChatApplication,
        require_container=True,
        legacy_getter=lambda: _agent_chat_application,
        legacy_setter=lambda instance: globals().__setitem__('_agent_chat_application', instance),
    )
