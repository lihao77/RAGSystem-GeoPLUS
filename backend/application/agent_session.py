...
_agent_session_application: Optional[AgentSessionApplication] = None


def get_agent_session_application() -> AgentSessionApplication:
    global _agent_session_application
    return get_runtime_dependency(
        container_getter='get_agent_session_application',
        fallback_name='agent_session_application',
        fallback_factory=AgentSessionApplication,
        require_container=True,
        legacy_getter=lambda: _agent_session_application,
        legacy_setter=lambda instance: globals().__setitem__('_agent_session_application', instance),
    )
