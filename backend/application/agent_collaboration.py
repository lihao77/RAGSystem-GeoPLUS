...
_agent_collaboration_application: Optional[AgentCollaborationApplication] = None


def get_agent_collaboration_application() -> AgentCollaborationApplication:
    global _agent_collaboration_application
    return get_runtime_dependency(
        container_getter='get_agent_collaboration_application',
        fallback_name='agent_collaboration_application',
        fallback_factory=AgentCollaborationApplication,
        require_container=True,
        legacy_getter=lambda: _agent_collaboration_application,
        legacy_setter=lambda instance: globals().__setitem__('_agent_collaboration_application', instance),
    )
