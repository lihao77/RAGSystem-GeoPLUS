...
_vector_retrieval_capability: Optional[VectorRetrievalCapability] = None


def get_vector_retrieval_capability() -> VectorRetrievalCapability:
    global _vector_retrieval_capability
    return get_runtime_dependency(
        container_getter='get_vector_retrieval_capability',
        fallback_name='vector_retrieval_capability',
        fallback_factory=VectorRetrievalCapability,
        require_container=True,
        legacy_getter=lambda: _vector_retrieval_capability,
        legacy_setter=lambda instance: globals().__setitem__('_vector_retrieval_capability', instance),
    )
