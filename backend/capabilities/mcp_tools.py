...
_mcp_tools_capability: Optional[MCPToolsCapability] = None


def get_mcp_tools_capability() -> MCPToolsCapability:
    global _mcp_tools_capability
    return get_runtime_dependency(
        container_getter='get_mcp_tools_capability',
        fallback_name='mcp_tools_capability',
        fallback_factory=MCPToolsCapability,
        require_container=True,
        legacy_getter=lambda: _mcp_tools_capability,
        legacy_setter=lambda instance: globals().__setitem__('_mcp_tools_capability', instance),
    )
