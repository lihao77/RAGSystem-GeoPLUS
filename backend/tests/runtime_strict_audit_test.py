...
class RuntimeStrictAuditTest(unittest.TestCase):
    ...
    def test_core_p1_targets_are_marked_container_only(self) -> None:
        ...
        expected = {
            ...
            ('backend/db.py', 'neo4j_connection'),
            ...
            ('backend/nodes/config_store.py', 'node_config_store'),
            ('backend/nodes/registry.py', 'node_registry'),
            ...
            ('backend/services/config_service.py', 'config_service'),
            ('backend/services/embedding_model_service.py', 'embedding_model_service'),
            ('backend/services/function_call_service.py', 'function_call_service'),
            ('backend/services/graphrag_api_service.py', 'graphrag_api_service'),
            ('backend/services/graphrag_service.py', 'graphrag_service'),
            ('backend/services/home_service.py', 'home_service'),
            ('backend/services/mcp_service.py', 'mcp_service'),
            ('backend/services/model_adapter_service.py', 'model_adapter_service'),
            ('backend/services/node_service.py', 'node_service'),
            ('backend/services/query_service.py', 'query_service'),
            ('backend/services/search_service.py', 'search_service'),
            ...
            ('backend/services/visualization_service.py', 'visualization_service'),
            ('backend/services/workflow_service.py', 'workflow_service'),
        }
